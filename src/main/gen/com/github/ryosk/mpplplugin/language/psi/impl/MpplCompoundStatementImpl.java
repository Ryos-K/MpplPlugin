...
public class MpplCompoundStatementImpl extends ASTWrapperPsiElement implements MpplCompoundStatement {

  public MpplCompoundStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
