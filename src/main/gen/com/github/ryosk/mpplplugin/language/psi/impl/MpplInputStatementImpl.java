...
public class MpplInputStatementImpl extends ASTWrapperPsiElement implements MpplInputStatement {

  public MpplInputStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MpplVariable> getVariableList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MpplVariable.class);
  }
