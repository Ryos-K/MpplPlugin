...
public class MpplArrayTypeImpl extends ASTWrapperPsiElement implements MpplArrayType {

  public MpplArrayTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MpplStandardType getStandardType() {
    return findNotNullChildByClass(MpplStandardType.class);
  }
