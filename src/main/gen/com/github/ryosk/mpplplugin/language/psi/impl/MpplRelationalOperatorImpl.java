...
public class MpplRelationalOperatorImpl extends ASTWrapperPsiElement implements MpplRelationalOperator {

  public MpplRelationalOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
