...
public class MpplFormalParametersImpl extends ASTWrapperPsiElement implements MpplFormalParameters {

  public MpplFormalParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
