...
public class MpplAdditiveOperatorImpl extends ASTWrapperPsiElement implements MpplAdditiveOperator {

  public MpplAdditiveOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
