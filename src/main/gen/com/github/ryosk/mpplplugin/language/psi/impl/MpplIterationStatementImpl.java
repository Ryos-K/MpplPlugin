...
public class MpplIterationStatementImpl extends ASTWrapperPsiElement implements MpplIterationStatement {

  public MpplIterationStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MpplStatement getStatement() {
    return findNotNullChildByClass(MpplStatement.class);
  }
