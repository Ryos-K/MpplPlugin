...
public class MpplVariableDeclarationImpl extends ASTWrapperPsiElement implements MpplVariableDeclaration {

  public MpplVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MpplType> getTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MpplType.class);
  }
