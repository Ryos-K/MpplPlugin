...
public class MpplTypeImpl extends ASTWrapperPsiElement implements MpplType {

  public MpplTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MpplArrayType getArrayType() {
    return findChildByClass(MpplArrayType.class);
  }
