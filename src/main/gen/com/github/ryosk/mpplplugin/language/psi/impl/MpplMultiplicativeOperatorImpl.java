...
public class MpplMultiplicativeOperatorImpl extends ASTWrapperPsiElement implements MpplMultiplicativeOperator {

  public MpplMultiplicativeOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
