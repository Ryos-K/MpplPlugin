...
public class MpplExpressionsImpl extends ASTWrapperPsiElement implements MpplExpressions {

  public MpplExpressionsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MpplExpression> getExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MpplExpression.class);
  }
